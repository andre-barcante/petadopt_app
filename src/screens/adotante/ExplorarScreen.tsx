    ...
    <TouchableOpacity style={styles.card} onPress={onPress} activeOpacity={0.85}>
      <View style={[styles.cardTop, { backgroundColor: bgColor }]}>
        {pet.fotoUrl
          ...
          : <View style={styles.cardEmojiWrap}><Text style={styles.cardEmoji}>{especieEmoji(pet.especie)}</Text></View>
        }
      </View>
...
const styles = StyleSheet.create({
  ...
  cardTop: {},
  cardPhoto: { alignSelf: 'stretch', aspectRatio: 1, resizeMode: 'cover' },
  cardEmojiWrap: { alignItems: 'center', paddingVertical: 20 },
